			...
			<div className='content'>
				...
				<div className='home-info'>
					...
					<div className='home-info__about-me'>
						Jestem początkującym programistą front-end. Interesuję się tworzeniem nowoczesnych interfejsów i wykonywaniem aplikacji webowych korzystając z technologii ReactJS, TypeScript i Sass.
					</div>
