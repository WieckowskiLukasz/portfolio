...
export const SkillsContent: {pl: Array<SkillItemInterface>, en: Array<SkillItemInterface>} = {
  pl: [
    {
      title: 'HTML5',
...
export const BasicKnowledgeContent: {pl: Array<SkillItemInterface>, en: Array<SkillItemInterface>} = {
  pl: [
    {
      title: 'PHP',
